...
public class Day12_ExtentReports extends TestBase {
    ...
    public void extentReportsTest(){
        extentTest.pass("Login in successful"); // pass is used to mark as passed
...
//       in testing we can use extent reports within conditions
    ...
    public void extentReportsTest2() throws IOException {
        ...
        extentTest
                ...
                .addScreenCaptureFromPath(captureScreenshotEntirePageAsString(),"Home Page"); // optional : adding screenshot at this point
...
//        When user type “uni” in the search box
        ...
        extentTest
                ...
                .addScreenCaptureFromPath(captureScreenshotEntirePageAsString(),"United Kingdom Select");
...
//        Then verify the result contains ‘United Kingdom’
        ...
        extentTest
                ...
                .addScreenCaptureFromPath(captureScreenshotEntirePageAsString(),"Result contains United Kingdom");

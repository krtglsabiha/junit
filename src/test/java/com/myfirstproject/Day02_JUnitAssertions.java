...
public class Day02_JUnitAssertions {
  ...
  ******************************************
  ...
  In JUnit5 Assertions class is used to do assertion (Assert class is used in JUnit)
         Assertion.assertEquals
         Assertion.assertTrue
         Assertion.assertFalse
         Assertion.assertNull
  *******************************************
  These assertions are HARD ASSERT, it means if assertions fails, test case STOPS and do not execute the rest of that test case
